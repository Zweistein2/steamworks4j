...
void convertGameServerItem(jobject item, JNIEnv* env, const gameserveritem_t& server) {
	...
	jclass itemClazz = env->FindClass("com/codedisaster/steamworks/matchmaking/SteamMatchmakingGameServerItem");

	jfieldID field = env->GetFieldID(itemClazz, "netAdr", "Lcom/codedisaster/steamworks/matchmaking/SteamMatchmakingServerNetAdr;");
	jclass netAdrClazz = env->FindClass("com/codedisaster/steamworks/matchmaking/SteamMatchmakingServerNetAdr");
