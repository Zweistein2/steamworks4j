...
public class SteamFriends extends SteamInterface {
	...
	public static class FriendGameInfo {
		...
		public SteamID getSteamIDLobby() {
			return SteamID.createFromNativeHandle(steamIDLobby);
		}
	}
	...
	public enum OverlayToUserDialog {
		...
		OverlayToUserDialog(final String id) {
			this.id = id;
		}
	}
	...
	public SteamID getFriendByIndex(final int friend, final FriendFlags friendFlag) {
		return SteamID.createFromNativeHandle(getFriendByIndex(pointer, friend, friendFlag.bits));
	}

	public SteamID getFriendByIndex(final int friend, final Collection<FriendFlags> friendFlags) {
		return SteamID.createFromNativeHandle(getFriendByIndex(pointer, friend, FriendFlags.asBits(friendFlags)));
	}
	...
	public void activateGameOverlayToWebPage(final String url, final OverlayToWebPageMode mode) {
