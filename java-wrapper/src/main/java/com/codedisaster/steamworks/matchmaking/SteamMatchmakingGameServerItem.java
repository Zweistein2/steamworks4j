...
import com.codedisaster.steamworks.matchmakingservers.SteamMatchmakingServerNetAdr;

public class SteamMatchmakingGameServerItem {

	final SteamMatchmakingServerNetAdr netAdr = new SteamMatchmakingServerNetAdr();
	int ping;
	...
	public SteamID getSteamID() {
		return SteamID.createFromNativeHandle(steamID);
	}
