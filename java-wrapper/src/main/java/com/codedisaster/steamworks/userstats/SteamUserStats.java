...
public class SteamUserStats extends SteamInterface {
	...
	public SteamUserStats(final SteamUserStatsCallback callback) {
	...
	public int getStatI(final String name, final int defaultValue) {
	...
	public boolean setStatI(final String name, final int value) {
		return setStat(pointer, name, value);
	}

	public float getStatF(final String name, final float defaultValue) {
	...
	public boolean setStatF(final String name, final float value) {
		return setStat(pointer, name, value);
	}

	public boolean isAchieved(final String name, final boolean defaultValue) {
	...
	public boolean setAchievement(final String name) {
		return setAchievement(pointer, name);
	}

	public boolean clearAchievement(final String name) {
	...
	public boolean indicateAchievementProgress(final String name, final int curProgress, final int maxProgress) {
	...
	public String getAchievementName(final int index) {
		return getAchievementName(pointer, index);
	}

	public boolean resetAllStats(final boolean achievementsToo) {
		return resetAllStats(pointer, achievementsToo);
	}

	public SteamAPICall findOrCreateLeaderboard(final String leaderboardName,
												final LeaderboardSortMethod leaderboardSortMethod,
												final LeaderboardDisplayType leaderboardDisplayType) {
	...
	public SteamAPICall findLeaderboard(final String leaderboardName) {
		return new SteamAPICall(findLeaderboard(pointer, callback, leaderboardName));
	}

	public String getLeaderboardName(final SteamLeaderboardHandle leaderboard) {
		return getLeaderboardName(pointer, leaderboard.handle);
	}

	public int getLeaderboardEntryCount(final SteamLeaderboardHandle leaderboard) {
		return getLeaderboardEntryCount(pointer, leaderboard.handle);
	}

	public LeaderboardSortMethod getLeaderboardSortMethod(final SteamLeaderboardHandle leaderboard) {
		return LeaderboardSortMethod.values()[getLeaderboardSortMethod(pointer, leaderboard.handle)];
	}

	public LeaderboardDisplayType getLeaderboardDisplayType(final SteamLeaderboardHandle leaderboard) {
		return LeaderboardDisplayType.values()[getLeaderboardDisplayType(pointer, leaderboard.handle)];
	}

	public SteamAPICall downloadLeaderboardEntries(final SteamLeaderboardHandle leaderboard,
												   final LeaderboardDataRequest leaderboardDataRequest,
	...
	public SteamAPICall downloadLeaderboardEntriesForUsers(final SteamLeaderboardHandle leaderboard,
														   final SteamID[] users) {
	 ...
	 */
	public boolean getDownloadedLeaderboardEntry(final SteamLeaderboardEntriesHandle leaderboardEntries,
												 final int index, final SteamLeaderboardEntry entry, final int[] details) {
	 ...
	 */
	public SteamAPICall uploadLeaderboardScore(final SteamLeaderboardHandle leaderboard,
											   final LeaderboardUploadScoreMethod method,
											   final int score, final int[] scoreDetails) {
	...
	public SteamAPICall requestGlobalStats(final int historyDays) {
		return new SteamAPICall(requestGlobalStats(pointer, callback, historyDays));
	}

	public long getGlobalStat(final String name, final long defaultValue) {
	...
	public double getGlobalStat(final String name, final double defaultValue) {
	...
	public int getGlobalStatHistory(final String name, final long[] data) {
		return getGlobalStatHistory(pointer, name, data, data.length);
	}

	public int getGlobalStatHistory(final String name, final double[] data) {
		return getGlobalStatHistory(pointer, name, data, data.length);
	}
